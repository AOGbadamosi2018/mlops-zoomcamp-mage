...
def hyperparameter_tuning(training_set: Dict[str, Union[Series, csr_matrix]],  **kwargs,) _> Tuple[Dict[str, Union[bool, float , int, str]], csr_matrix, Series,]:
    ...
    #inclued campturing the callback url in the hyper parameter metrics
    best_hyperparameters = tune_hyperparameters(training, validation, callback = lambda **opts: track_experiment(**{**opts,**kwargs}),**kwargs,)
